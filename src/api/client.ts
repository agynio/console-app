...
import { ImagesGateway } from '@/gen/agynio/api/gateway/v1/images_pb';
import { LLMGateway } from '@/gen/agynio/api/gateway/v1/llm_pb';
import { MeteringGateway } from '@/gen/agynio/api/gateway/v1/metering_pb';
import { NetworksGateway } from '@/gen/agynio/api/gateway/v1/networks_pb';
...
export const networksClient = createClient(NetworksGateway, transport);
